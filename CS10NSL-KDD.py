...
df_train = pd.read_csv(r"D:\intern\internship\archive3\KDDTrain+.txt", header=None, names=columns)
df_test = pd.read_csv(r"D:\intern\internship\archive3\KDDTest+.txt", header=None, names=columns)
